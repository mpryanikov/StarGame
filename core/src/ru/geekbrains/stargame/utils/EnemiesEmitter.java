...
public class EnemiesEmitter {
    ...
    private static final int ENEMY_MEDIUM_HP = 5; //количество жизней
    ...
    private static final int ENEMY_BIG_HP = 20; //количество жизней

    private Rect worldBounds;

    //скорость генерации кораблей
    private float generateInterval = 4f;
    private float generateTimer;

    //массив регионов для маленького корабля
    private TextureRegion[] enemySmallRegion;
    private TextureRegion[] enemyMediumRegion;
    private TextureRegion[] enemyBigRegion;

    //скорость маленького корабля
